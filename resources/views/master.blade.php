    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-lg-2 pr-4 align-items-center">
		    		<a class="navbar-brand" href="index">Dr.<span>care</span></a>
	    		</div>
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
			    		<div class="col-md-4 pr-4 d-flex topper align-items-center">
			    			<div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-map"></span></div>
						    <span class="text">14A-lê Quý đôn Khu 2, Phường Hải Tân, Thành Phố Hải Dương</span>
					    </div>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item @yield('home')"><a href="index" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item @yield('about')"><a href="about" class="nav-link">Thông tin</a></li>
	        	<li class="nav-item @yield('doctor')"><a href="doctor" class="nav-link">Bác sĩ</a></li>
	        	<li class="nav-item @yield('department')"><a href="department" class="nav-link">Chuyên Khoa</a></li>
	        	<li class="nav-item @yield('pricing')"><a href="pricing" class="nav-link">Đánh Giá</a></li>
	        	<li class="nav-item @yield('blog')"><a href="blog" class="nav-link">Blog</a></li>
	          <li class="nav-item @yield('contact')"><a href="contact" class="nav-link">Liên Hệ</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
