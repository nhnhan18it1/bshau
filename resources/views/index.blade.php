    ...
    <div class="slider-item" style="background-image: url('public/images/imgBH/812bddf2_o.jpeg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        ...
        <div class="col-md-6 text ftco-animate">
          <h1 class="mb-4">Helping Your <span style="color: black;" >Stay Happy One</span></h1>
          <h3 style="color: rgb(238, 58, 3);font-size: 18px;font-weight: 400;text-transform: uppercase;font-style: inherit;" class="">Everyday We Bring Hope and Smile to the Patient We Serve</h3>
